...
export const assemblyCards = pgTable("assembly_cards", {
  ...
  status: text("status").notNull().default("scheduled"), // "scheduled", "in_progress", "completed", "blocked", "ready_for_build"
...
export const updateAssemblyCardSchema = z.object({
  ...
  status: z.enum(["scheduled", "in_progress", "completed", "blocked", "ready_for_build"]).optional(),
